...
- **Article 11 — You Have the Right to Safe, Tested, Honest Systems.** Do not ship a capability that was never evaluated for the use it will actually see. Surface the model's limits in the product itself: uncertainty, refusal, and "I can't do this" are features, not failures. Publish known failure modes and error rates.
