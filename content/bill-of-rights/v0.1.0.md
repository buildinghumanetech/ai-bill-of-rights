...
changelog: Adds Article 10 (Freedom From Algorithmic Discrimination) and Article 11 (You Have the Right to Safe, Tested, Honest Systems). Articles 1-9 carry over from v0.0.1 unchanged.
...
No AI system may produce different outcomes for you because of your race, ethnicity, gender, disability, age, religion, sexual orientation, or any other protected characteristic — in hiring, lending, housing, healthcare, policing, insurance, or education. {#article-10-s-1} Disparate impact counts even when no one intended it. {#article-10-s-2} Companies must test for it before deployment, publish what they find, and fix what they break. {#article-10-s-3} No AI may treat you differently for who you are. {#article-10-s-4}

## Article 11: You Have the Right to Safe, Tested, Honest Systems {#article-11}

An AI system released into the world must be tested for the things people will actually use it for, and must say plainly what it cannot do. {#article-11-s-1} No shipping capabilities that were never evaluated. {#article-11-s-2} No confident answers in domains the system was never validated in. {#article-11-s-3} Known limitations, failure modes, and error rates belong in public before deployment — not discovered afterward by the people harmed. {#article-11-s-4} It has to work, and admit what it can't do. {#article-11-s-5}
