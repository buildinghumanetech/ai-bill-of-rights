...
changelog: Adds Article 10 (Freedom From Algorithmic Discrimination) and Article 11 (You Have the Right to Safe, Tested Systems). Articles 1-9 carry over from v0.0.1 unchanged.
...
## Article 11: You Have the Right to Safe, Tested Systems {#article-11}

Before an AI system is used to make a decision about you, it must be tested and shown to be safe and effective. {#article-11-s-1} The burden of proving it works falls on the company that builds it, not on you to prove it broke you after the fact. {#article-11-s-2}
